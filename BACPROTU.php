...
<!------ code pour la navbar---------->
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1>BAC PRO TU</h1>
                <p data-aos="fade-up" data-aos-delay="100">Technicien d'usinage</p>
              </div>
            </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
              <img src="photo/PRO TU.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-5 ml-auto">
            <h2 class="text-primary mb-3">BAC PRO TU</h2>
            <p>Le Bac pro TU forme des ouvriers qualifiés dans la fabrication mécanique. En s'appuyant sur le dossier de fabrication, ce technicien s'occupe des procédures de fabrication de pièces métalliques qui devront être usinées (enlèvement de matière). Il se charge ensuite de leur production en préparant, installant et réglant les outils et machines nécessaires pour effectuer le travail sur la pièce. Il doit, pour finir, contrôler la qualité. Il maîtrise les logiciels de conception assistée par ordinateur (CAO) et de fabrication assistée par ordinateur (FAO).</p>


            <ul class="ul-check list-unstyled succes">
              <li>Analyse et exploitation de données techniques</li>
              <li>Élaboration d'un processus d'usinage</li>
              <li>Réalisation et suivi de production en entreprise</li>
            </ul>
          </div>
        </div>
      </div>
