  ...
  <div class="site-wrap">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1>BAC STI2D</h1>
                <p data-aos="fade-up" data-aos-delay="100">SCIENCES ET TECHNOLOGIES DE L'INDUSTRIE ET DU DÉVELOPPEMENT DURABLE</p>
              </div>
            </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <img src="photo/stid2.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-5 ml-auto">
            <h2 class="text-primary mb-3">BAC STI2D</h2>
            <p> La série STI2D permet d'acquérir des compétences technologiques transversales à tous les domaines industriels, ainsi que des compétences approfondies dans un champ de spécialité.

Les programmes de mathématiques et de physique-chimie sont adaptés pour vous donner les outils scientifiques nécessaires aux enseignements technologiques.</p>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md-4 text-left border-primary">
            <h2 class="font-weight-light text-primary">Presentation des quatre options :</h2>
            <p class="color-black-opacity-5">Il existe quatre types d'options l'une axée sur les sytemes d'informations, une sur l'inovation techonologique, sur l'energie et l'environement et pour finir sur l'architeture et les constructions.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
            <img src="photo/systemeinformation.png" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">BAC STI2D</h3>
            <p class="caption text-primary">systeme d'information:</p>
            <p> Cette spécialité porte sur l’analyse et la création de solutions techniques, relatives au traitement des flux d’information (voix, données, images), dans les systèmes pluri-techniques actuels qui comportent à la fois une gestion locale et une gestion à distance de l’information. Les supports privilégiés sont les systèmes de télécommunications, les réseaux informatiques, les produits pluri-techniques et, en particulier, les produits multimédias. Les activités portent sur le développement de systèmes virtuels destinés à la conduite, au dialogue homme-machine, à la transmission et à la restitution de l’information.</p>

          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
            <img src="photo/innovation.png" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">BAC STI2D</h3>
            <p class="caption text-primary"> Inovation technologique:</p>
            <p>Cette spécialité porte sur l’analyse et la création de solutions techniques, relatives à la structure et à la matière, qui respectent des contraintes économiques et environnementales. Cette approche développe des compétences dans l’utilisation des outils de conception et dans la prise en compte des contraintes liées aux matériaux et aux procédés.</p>
          </div>

            <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
              <img src="photo/environement.png" alt="Image" class="img-fluid mb-3">
              <h3 class="h4">BAC STI2D</h3>
              <p class="caption text-primary">l'energie et l'environement:</p>
            ...
            <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
              <img src="photo/architecture.png" alt="Image" class="img-fluid mb-3">
              <h3 class="h4">BAC STI2D</h3>
              <p class="caption text-primary">Architecture et construction:</p>
...
<!------ presentation des comission---------->
          <section class="contact_area section_ga">
            <div class="container">
              <div class="row">
                <div class="col-lg-3">
          ...
          </section><!------ postuler a la formations---------->
