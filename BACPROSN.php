...
<!------ navbar---------->
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1>BAC PRO SN</h1>
                <p data-aos="fade-up" data-aos-delay="100">Systeme numerique</p>
              </div>
            </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
              <img src="photo/PRO SN.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-5 ml-auto">
            <h2 class="text-primary mb-3">BAC PRO SN</h2>
            <p>Ce bac pro aborde l'ensemble des compétences professionnelles permettant au technicien d'exercer les activités liées à la préparation, l'installation, la maintenance des systèmes dans son domaine. Le titulaire sera aussi capable de participer au service client avec les services commerciaux.</p>


            <ul class="ul-check list-unstyled succes">
              <li>informatique</li>
              <li>Resaux</li>
              <li>electronique, communication</li>
            </ul>
          </div>
        </div>
      </div>
