...
<!------ lien pour le styles des deux templates---------->
  </head>
  <body>
  ...
  <div class="site-wrap">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1>Troisieme prepa pro</h1>
                <p data-aos="fade-up" data-aos-delay="100">Troisieme preaparation professionnel</p>
              </div>
            </div> <!------ nav bar ---------->
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <img src="photo/cprp.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-5 ml-auto">
            <h2 class="text-primary mb-3">Troisieme prepa pro</h2>
            ...
            <ul class="ul-check list-unstyled succes">
              <li>Enseignement informatique et technologique</li>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md-4 text-left border-primary">
            <h2 class="font-weight-light text-primary">Aucune option:</h2>
            <p class="color-black-opacity-5">L’enseignement professionnel n’est pas une spécialisation, il s’appuie sur la mise en place de situations d’apprentissage et expérimentales qui consistent à mettre l’élève en situation de réussite.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
            <img src="photo/visite.png" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">Troisieme prepa pro</h3>
            <p class="caption text-primary">A quoi sert la troisième prepa pro ?</p>
            <p>La 3ème PEP (Préparatoire à l'enseignement Professionnel) est une chance offerte aux élèves qui ont besoin d'un support professionnel pour reprendre goût à leurs études. Elle accueille des élèves provenant de 4ème de collège, 4ème alternance et 3ème de collège. Cette classe est implantée dans le lycée professionnel.</p>
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
            <img src="photo/assemblee.png" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">Troisieme prepa pro</h3>
            <p class="caption text-primary">Que faire apres une prepa pro ?</p>
            <p>En classe de 3e, les élèves font leurs choix d'orientation, vers une 2de générale et technologique ou agricole, en lycée, ou vers un CAP ou un bac pro, en lycée professionnel, par voie scolaire ou par apprentissage.</p>
          </div>
          ...
          <div class="site-section "  data-aos="fade">
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
                  <img src="photo/cprp2.png" alt="Image" class="img-fluid mb-3">
                  <h3 class="h4">BTS CPRP Option production unitaire</h3>
                  <p class="caption text-primary">Option production unitaire :</p>
                  <p>Choix du procédé, définition du processus général de fabrication, encadrement des opérateurs de fabrication pour la réalisation et le contrôle, coordination des activités de mise en production, vérification de la conformité du sous-ensemble jusqu’à la présentation au client.</p>
                </div>
                <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
                  <img src="photo/cprp3.png" alt="Image" class="img-fluid mb-3">
                  <h3 class="h4">BTS SIO CPRP Option production sérielle</h3>
                  <p class="caption text-primary">Option production sérielle :</p>
                  <p>Intervention dès la conception du procédé jusqu’à la pré-industrialisation des produits, conception des processus de fabrication et d’assemblage ainsi que les outillages associés, lancement ou suivi des productions.</p>
                </div>
<!------ presentation de la formation---------->
                <br/><br/><h1>Troisième prepa pro</h1><br/><br/>
...
<!------ comission d'admissions---------->
                ...
                <div class="col-lg-3">
                  <div class="contact_info">
                    <div class="info_item">
                      ...
                      <p>Troisieme prepa pro</p>
                    </div>
                    <div class="info_item">
                      <i class="	fa fa-home"></i>
                      <h6><a href="#">Lycee Robert Schuman</a></h6>
                      <p>5 avenue du Général de Gaulle - 93440 Dugny</p>
                    </div>
                    <div class="info_item">
                      <i class="	fa fa-phone-square"></i>
                      <h6><a href="#">administration@lyceerobertschuman.com</a></h6>
                      <p>01 48 37 74 26</p>
                    </div>
                  </div>
                </div>
          ...
          </section> <!------ code pour s'sincrirea une Formation---------->
...
</html> <!------ code pour le ava script des templates---------->
