                  ...
                  <div class="row">
                      <div class="col-md-3 register-left">
                        <form action="administration.php">
                          ...
                          <input type="submit" name="" value="Administration"/><br/>
                        </form>
                      </div>
                      <div class="col-md-9 register-right">
                          <form action="aj_administrateur.php" method="POST">
                          <div class="tab-content" id="myTabContent">
                              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                  <h3 class="register-heading">Ajouter un administrateurer</h3>
...
</form><!------ formulaire pour ajouter un individue---------->
