...
<!------ Fond de la nav bar---------->
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1>BAC PRO MEI</h1>
                <p data-aos="fade-up" data-aos-delay="100">Maintenance des Équipements Industriels</p>
              </div>
            </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
              <img src="photo/BAC PRO MEI.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-5 ml-auto">
            <h2 class="text-primary mb-3">BAC PRO MEI</h2>
    ...
    </div> <!------ code pour l'image plus la presentation de la formation---------->
...
<!------ code pour les commisions d'admissions---------->
          ...
          </section> <!------ code pour postuler a la plus la formations---------->
